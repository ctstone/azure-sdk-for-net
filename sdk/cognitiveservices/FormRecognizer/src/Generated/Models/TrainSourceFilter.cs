...
namespace Microsoft.Azure.CognitiveServices.FormRecognizer.Models
{
    ...
    public partial class TrainSourceFilter
    {
        ...
        /// documents in the source path for training. For example, when using
        /// a Azure storage blob Uri, use the prefix to restrict sub folders
        /// for training.</param>
        ...
        /// searching for content to be preprocessed.</param>
        ...
        /// the source path for training. For example, when using a Azure
        /// storage blob Uri, use the prefix to restrict sub folders for
        /// training.
        /// </summary>
        ...
        /// prefix folders will also need to be included when searching for
        /// content to be preprocessed.
        /// </summary>
        ...
        public virtual void Validate()
        {
            if (Prefix != null)
            {
                ...
                {
                    throw new ValidationException(ValidationRules.MaxLength, "Prefix", 1024);
                }
                if (Prefix.Length < 0)
                {
